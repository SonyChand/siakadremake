...
<body>
    ...
    <table width="100%">
        <tr>
            <td><strong>Pasien:</strong> <?= hideName($onePas->nama) ?></td>
            <td style="text-align: right;"><strong>NIK:</strong> <?= hideNik($onePas->nik) ?></td>
        </tr>
        ...
        <tbody>
            ...
            foreach ($medData as $row) : ?>
                <tr>
                    ...
                    <td><?= tanggal_indonesia(date('Y-m-d', $row->tgl_dibuat)) ?> <?= date('H:i', $row->tgl_dibuat) ?></td>
                </tr>
            <?php endforeach; ?>
    </table>
