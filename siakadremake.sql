...
-- Dumping data for table siakadremake.kurikulum: ~0 rows (approximately)
...
-- Dumping data for table siakadremake.mata_pelajaran: ~1 rows (approximately)
...
INSERT INTO `menu` (`id`, `menu`, `link`, `icon`, `for`, `order`, `status`) VALUES
	...
	(17, 'Penilaian', 'penilaian/penilaian', 'fas fa-clipboard-list', '1', 5, 1);
...
-- Dumping data for table siakadremake.pengguna: ~19 rows (approximately)
INSERT INTO `pengguna` (`id`, `nama`, `email`, `password`, `image`, `role`, `no_hp`, `jenis_kelamin`, `tgl_dibuat`, `terakhir_login`, `status`) VALUES
	(1, 'Lord Daud', 'abahdaud@gmail.com', '$2y$10$dXy5ySWJtvxf9yUluodeguV1WReKdM/mTlfYUMLKpul6hroIBIDmO', '1723673645_53df239a7a21e9d3506d8b13384fae2c1723673645.jpg', 1, '081312157307', 'L', 1658915944, 1724232226, 1),
...
-- Dumping data for table siakadremake.penilaian: ~1 rows (approximately)
...
-- Dumping data for table siakadremake.penjadwalan: ~3 rows (approximately)
...
-- Dumping data for table siakadremake.rapor: ~2 rows (approximately)
...
-- Dumping data for table siakadremake.siswa: ~2 rows (approximately)
INSERT INTO `siswa` (`id`, `id_kelas`, `nik`, `no_kk`, `nisn`, `nama`, `tpt_lahir`, `tgl_lahir`, `jk`, `no_hp`, `agama`, `cita_cita`, `hobi`, `alamat`, `nama_ayah`, `tgl_dibuat`) VALUES
	(2, 148, '3207332005030002', '215125125125', '12512512', 'Lord Daud', 'Ciamis', 1724086800, 'L', '0831285125125', 'Islam', 'dad', 'dad', 'dasd', 'dad', 1723466709),
	(3, 148, '3207332005050004', '215125125125', '1251251221', 'Ananda Chandra', 'Ciamis', 1724864400, 'P', '081312157307', 'Islam', 'dads', 'dad', 'as', 'dad', 1723469930),
	(4, 149, '3206380403210093', '21512512512512', '0009358501', 'Sony Chandra Maulana', 'Ciamis', 1724346000, 'L', '081273627132', 'Islam', 'Pengangguran', 'Tidur', 'e', '4', 1723671515);
...
-- Dumping data for table siakadremake.submenu: ~8 rows (approximately)
